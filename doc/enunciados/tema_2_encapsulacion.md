...
----------------
La encapsulacion tiene que ver con "proteccion". Evito estados no válidos de mis objetos, también evito dependencias desde fuera que no quiero. Encapsulacion: he juntado estado y comportamiento en un artefacto (la clase) y ahora puedo ocultar ciertas partes al exterior
...
-----------------
Interfaz publico: Los miembros que se ven desde fuera, es decir, los que estan ocutlso
...
-------------
Invariantes de clases: Condiciones que los objetos de esa clase deben cumplir pero son validos y durante toda la vida del objeto. CuentaBancaria debe de tener saldo positivo. Persona debe de tener edad mayor que 0. 
...
-------------------
Public: clases, atributos y metodos
Private: clases internas(no las estamos viendo), atributos y metodos.
...
----------------
Protected: solo se ve desde "subclases" (las vemremos en el tema de herencia)
...
-------------
setter y getter permiten dar acceso a atributos privados para obtener su valor o para cambiarlos
...
---------------
no, esto no es ciberseguridad, es facilitar una programacion con menos bugs
...
-------------
Miembro de clase: no asociado a ninguna instancia, es compartida por todas las instancias. En métodos no hay this.
Miembro de instancia: Esta asociado a cada instancia, no son compartidas
...
- Cuando prefiereas usar metodos factoria.
